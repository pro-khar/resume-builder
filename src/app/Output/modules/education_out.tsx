                ...
                <div id="part_container" className="flex flex-col mt-1 leading-[1.4]">
                    <table className="w-full" >
                        <tr>
                            ...
                            <td className="py-0 px-2 text-right font-semibold">{education.bachelor_duration}</td>
                        </tr>
                        <tr>
                            <td className="py-0 px-2">{education.college}</td>
                            <td className="py-0 px-2 text-right">{education.bachelor_score}</td>
                        </tr>
                        <tr>
                    ...
                    {education.int_school ? (
                        <table className="w-full">
                            <tr>
                                <td className="py-0 px-2"><h1 className="font-semibold">Intermediate</h1></td>
                                <td className="py-0 px-2 text-right font-semibold">{education.int_year}</td>
                            </tr>
                            <tr>
                                <td className="py-0 px-2">{education.int_school}</td>
                                <td className="py-0 px-2 text-right">{education.int_score}</td>
                            </tr>
                        </table>
                    ) : null}
                    {education.hs_school ? (
                        <table className="w-full">
                            <tr>
                                <td className="py-0 px-2"><h1 className="font-semibold">High-school</h1></td>
                                <td className="py-0 px-2 text-right font-semibold">{education.hs_year}</td>
                            </tr>
                            <tr>
